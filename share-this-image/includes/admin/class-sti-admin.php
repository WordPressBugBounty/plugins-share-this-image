        ...
        */
        ...
        public function display_admin_page() {
            ...
            <div id="sti-admin-header">
                <div class="inner">
                    <div class="logo">
                        <img src="<?php echo STI_URL . '/assets/images/logo.png'; ?>" alt="<?php esc_attr_e( 'logo', 'share-this-image' ); ?>">
                        <span class="title">
                            <?php esc_html_e( 'Share This Image', 'share-this-image' ); ?>
                        </span>
                        <span class="version">
                            <?php echo 'v' . STI_VER; ?>
                        </span>
                    ...
                    <div class="btns">
                        <a class="button button-docs" href="https://share-this-image.com/guide/?utm_source=wp-plugin&utm_medium=header&utm_campaign=guide" target="_blank"><?php esc_html_e( 'Documentation', 'share-this-image' ); ?></a>
                        <a class="button button-support" href="https://wordpress.org/support/plugin/share-this-image/" target="_blank"><?php esc_html_e( 'Support', 'share-this-image' ); ?></a>
                        <a class="button button-pro" href="https://share-this-image.com/pricing/?utm_source=wp-plugin&utm_medium=header&utm_campaign=pricing" target="_blank"><?php esc_html_e( 'Get Pro Version', 'share-this-image' ); ?></a>
                    </div>
                </div>
            </div>
        ...
        public function admin_enqueue_scripts() {
            if ( isset( $_GET['page'] ) && $_GET['page'] == 'sti-options' ) {
                ...
                wp_enqueue_style( 'sti-select2', STI_URL . '/assets/css/select2.min.css' );
                wp_enqueue_style( 'sti-admin-style', STI_URL . '/assets/css/sti-admin' . $suffix . '.css', array(), STI_VER );

                wp_register_script( 'sti-select2', STI_URL . '/assets/js/select2.full.min.js', array( 'jquery' ), STI_VER );

                wp_enqueue_script( 'jquery' );
                wp_enqueue_script( 'sti-select2' );
                wp_enqueue_script( 'jquery-ui-sortable' );
                wp_enqueue_media();
                wp_enqueue_script( 'sti-admin-js', STI_URL . '/assets/js/admin' . $suffix . '.js', array('jquery', 'sti-select2', 'jquery-ui-sortable'), STI_VER );
